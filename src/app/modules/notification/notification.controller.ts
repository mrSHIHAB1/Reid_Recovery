...
const markRead = catchAsync(async (req: Request, res: Response) => {
  const { userId } = req.user as JwtPayload;
  await NotificationService.markAsRead(userId, req.params.notificationId as string);
...
const deleteNotificationController = catchAsync(async (req: Request, res: Response) => {
